    ...
    <nav class="msite_nav">
      <div class="swiper-container">
        <div class="swiper-wrapper" v-if="categorys.length">
          <div class="swiper-slide" v-for="(foodListArr, index) in categorysArr" :key="index">
            <div class="link_to_food" v-for="(category) in foodListArr" :key="category.id">
        ...
        <div v-else>
          <img src="./images/msite_back.svg" alt="loadding">
        </div>
        <!-- Add Pagination -->
      ...
      <div class="shop_container">
        ...
        <ul v-else>
          <li v-for="(li, index) in 4" :key="index">
            <img src="./images/shop_back.svg" alt="loadding">
          </li>
        </ul>
      </div>
    </div>
...
<script>
  ...
  export default {
    computed: {
      ...mapState(['adress', 'shops', 'categorys']),
      ...
      categorysArr () {
        ...
        const arr = []
        let listArr = []
        categorys.forEach((foodList) => {
          if (listArr.length === 0) {
            arr.push(listArr)
          }

          listArr.push(foodList)
