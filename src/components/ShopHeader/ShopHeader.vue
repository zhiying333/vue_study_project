  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="showNotice(true)">
    ...
    <div @click="showDiscount(true)" class="shop-header-discounts">
    ...
    <div class="shop-brief-modal" :style="{display: isShowNotice ? 'block' : 'none'}">
    ...
    <div class="activity-sheet" :style="{display: isShowDiscount ? 'block' : 'none'}">
